...
face_cascade = cv2.CascadeClassifier('C:\Users\Prajesh22\Desktop\haarcascade_frontalface_default.xml')
eye_cascade = cv2.CascadeClassifier('C:\Users\Prajesh22\Desktop\haarcascade_eye.xml')
eye_glasses_cascade = cv2.CascadeClassifier('C:\Users\Prajesh22\Desktop\haarcascade_eye_tree_eyeglasses.xml')
...
while True:
    ...
    cv2.ellipse(frame,(315,240),(100,115),0,0,360,200,1)
